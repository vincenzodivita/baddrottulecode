  ...
  return (
    <div className="App">
      <header className="App-header">
        <h1>baddrottuleCode</h1>
        <span>
          Benvenuto su Baddrottole Code, il mio spazio personale dove condivido le mie avventure di programmazione!
        </span>
     
        <h2>Un Gioco di Parole tra Cultura e Codice</h2>
        <p>
          Il nome del mio sito, Baddrottole Code, è un gioco di parole che fonde la tradizione siciliana con un termine ben noto nel mondo della programmazione: spaghetti code.
        </p>
